<template>
    <div>
        ...
        <swiper :slidesPerView="4" :spaceBetween="50" :modules="modules" class="mySwiper">
            <swiper-slide v-for="(item, index) in SVODs" :key="index" class="item bg-black no-border">
                <v-card class="stream-card">
                    <template slot="progress">
                        <v-progress-linear color="deep-purple" height="10" indeterminate></v-progress-linear>
                    </template>

                    <v-img :src=item.poster_url class="card-item-img">
                        <v-card-text class="live-card-item-mark">
                            ...
                            <v-progress-linear color="white" height="8" background-color="#019dff" background-opacity="0.6"
                                class="lcard-progress-bar"></v-progress-linear>
